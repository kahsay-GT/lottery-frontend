...
export function LotteryDetail() {
  ...
  const onSubmit = async (d: F) => {
    ...
    try {
      ...
      setPaymentId(pd.id); setRefCode(pd.referenceCode); setTotalAmount(qty * ticketPrice)
      setStep('upload')
      toast.success(t('lotteryDetail', 'ticketsReserved'))
    } catch (e) { toast.error(e instanceof Error ? e.message : t('lotteryDetail', 'reserveError')) }
